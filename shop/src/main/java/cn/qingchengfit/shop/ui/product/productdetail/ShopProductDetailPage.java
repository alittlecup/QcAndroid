  ...
  private void initToolbar() {
    ...
    toolbar.setNavigationOnClickListener(v -> {
      if (!TextUtils.isEmpty(content) && TextUtils.isEmpty(richTxtFragment.getContent())) {
        ViewUtil.instanceDelDialog(getContext(), getString(R.string.sure_clear_cur_content), (dialog, which) ->{switch (which){
          case POSITIVE:sendBack();break;
          case NEGATIVE:getActivity().onBackPressed();break;
        }}).show();
      } else {
