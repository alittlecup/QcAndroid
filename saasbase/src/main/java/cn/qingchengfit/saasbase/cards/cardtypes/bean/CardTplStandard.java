 ...
 */
public class CardTplStandard implements Parcelable {

  public static final Creator<CardTplStandard> CREATOR = new Creator<CardTplStandard>() {
    @Override public CardTplStandard createFromParcel(Parcel source) {
      return new CardTplStandard(source);
    }

    @Override public CardTplStandard[] newArray(int size) {
      return new CardTplStandard[size];
    }
  };
  public String id;
  ...
  public CardTplStandard(String content, String real_income, String support_type, String valid_date) {
  ...
  public CardTplStandard(boolean isAdd, String valid_date, String support_type, String real_income, String content) {
    this.isAdd = isAdd;
    this.valid_date = valid_date;
    this.support_type = support_type;
    this.real_income = real_income;
  ...
  protected CardTplStandard(Parcel in) {
