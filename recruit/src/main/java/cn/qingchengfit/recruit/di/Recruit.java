...
@Subcomponent(modules = Recruit.SeekPositionHomeFragmentModule.class) public interface Recruit extends AndroidInjector<RecruitActivity> {
  ...
  @Subcomponent() public interface ResumeEditDescFragmentSubcomponent extends AndroidInjector<ResumeEditDescFragment> {
    @Subcomponent.Builder public abstract class Builder extends AndroidInjector.Builder<ResumeEditDescFragment> {
    }
  }
  ...
  @Module(subcomponents = ResumeEditDescFragmentSubcomponent.class) abstract class ResumeEditDescFragmentModule {
    @Binds @IntoMap @FragmentKey(ResumeEditDescFragment.class)
    abstract Factory<? extends Fragment> bindYourFragmentInjectorFactory(ResumeEditDescFragmentSubcomponent.Builder builder);
  }
}
