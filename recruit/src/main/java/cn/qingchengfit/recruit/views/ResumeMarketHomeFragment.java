...
public class ResumeMarketHomeFragment extends ResumeListFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layoutFilter.setOnRefreshListener(this);
        initToolbar(toolbar);
        if (!CompatUtils.less21() && layoutSearch != null && this.isfitSystemPadding()) {
            layoutSearch.setPadding(0, MeasureUtils.getStatusBarHeight(this.getContext()), 0, 0);
        }
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        filterHeadItem.setListener(new FilterHeadItem.FilterHeadListener() {
            @Override
            public void onPositionClick(int pos) {
                if (pos == -1) {
    ...
    @Override
    public void onResumeList(List<Resume> resumes, int total, int page) {
    ...
    public void showFilter(int pos) {
        ...
        if (f == null) {
            ...
            ((ResumeFilterFragment) f).setListener(new ResumeFilterFragment.ResumeFilterListener() {
                @Override
                public void onFilterDone(HashMap<String, Object> params, String cityname) {
    ...
    @Override
    public void onEndFairList(List<EndFairTips> endFairList) {
    ...
    @Override
    public void onJobList(List<Job> jobs, int page, int totalCount) {
