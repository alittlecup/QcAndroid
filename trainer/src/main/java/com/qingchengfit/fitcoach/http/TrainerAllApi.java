...
public interface TrainerAllApi {
  ...
  @GET("/api/v1/coaches/{id}/gyms/welcome/")
  rx.Observable<QcDataResponse<GymDetail>> qcGetGymWelcome(@Path("id") String staffid,
  ...
  //获取认证列表
  @GET("/api/certificates/{id}/") rx.Observable<QcCertificateDetailResponse> qcGetCertificateDetail(
      @Path("id") int id);
  ...
  //获取教练销售 充值卡信息
  @GET("/api/v1/coaches/{id}/reports/sale/cardtpls/") rx.Observable<QcCardsResponse> qcGetSaleCard(
      @Path("id") int id);
  ...
  //获取所有健身房充值卡
  @GET("/api/coaches/{id}/systems/cardtpls/") rx.Observable<QcSystemCardsResponse> qcGetSystemCard(
      @Path("id") int id, @QueryMap Map<String, String> params);
  ...
  //获取团课排课
  @GET("/api/v1/coaches/{id}/group/courses/") rx.Observable<QcResponseGroupCourse> qcGetGroupCourse(
  ...
  rx.Observable<QcDataResponse<ArticleCommentListData>> qcQueryComments(@Path("news_id") String id,
      @QueryMap HashMap<String, Object> params);
  ...
  rx.Observable<QcDataResponse<CourseTypeSamples>> qcGetCoursesPermission(@Path("id") int staff_id,
      @Query("is_private") int is_private, @QueryMap HashMap<String, Object> params);
  ...
  //修改健身房
  @PUT("/api/gym/{id}/") rx.Observable<QcResponse> qcEditGym(@Path("id") String id,
  ...
  //百度pushid绑定
  @POST("/api/coaches/{id}/push/update/") rx.Observable<QcResponse> qcPostPushId(@Path("id") int id,
      @Body PushBody body);
  ...
  @PUT("/api/v1/coaches/{id}/{type}/{single_id}/") rx.Observable<QcResponse> qcUpdateSinglebatch(
      @Path("id") String staff_id, @Path("type") String type, @Path("single_id") String scheduleid,
