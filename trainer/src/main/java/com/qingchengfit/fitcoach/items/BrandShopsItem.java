...
//            .into(holder.imgBg);
        ...
        User_Student owner = brand.getOwners().get(0);
        holder.tvBuilderName.setText("创建人： " + owner.getUsername());
	...
	RecyclerView recyclerInsert;
        ...
        public BrandShopsVH(View view, FlexibleAdapter adapter) {
          ...
          btnManageBrand = (LinearLayout) view.findViewById(R.id.btn_manage_brand);
          tvBrandName = (TextView) view.findViewById(R.id.tv_brand_name);
          tvBuilderName = (TextView) view.findViewById(R.id.tv_builder_name);
