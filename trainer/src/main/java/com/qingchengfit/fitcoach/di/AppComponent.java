...
@Component(modules = {
    ...
    AppComponent.ChatChooseInGymFragmentModule.class, AppComponent.SplashModule.class,
    AppComponent.StatementDetailFragmentModule.class,
    AppComponent.CourseChooseDialogFragmentModule.class,
    AppComponent.CourseReverseFragmentModule.class, AppComponent.SaleDetailFragmentModule.class,
    AppComponent.SalerChooseDialogFragmentModule.class, AppComponent.ManageFragmentModule.class,
    AppComponent.CustomStatmentFragmentModule.class, AppComponent.BaseDialogFragmentModule.class,
    AppComponent.CustomSaleFragmentModule.class,
    AppComponent.CardTypeChooseDialogFragmentModule.class, AppComponent.Main2Module.class,
    AppComponent.UnLoginHomeFragmentModule.class, AppComponent.HomeBannerFragmentModule.class,
    AppComponent.MineFragmentFragmentModule.class, AppComponent.UnloginManageFragmentModule.class,
    AppComponent.SyncGymFragmentModule.class, AppComponent.ManageFragmentModule.class,
    AppComponent.SettingFragmentModule.class, AppComponent.ChooseGymTrainerFragmentModule.class,
    AppComponent.MyCoursePlanFragmentModule.class, AppComponent.ChooseModule.class,
    AppComponent.JobSearchChatModule.class, AppComponent.ConversationFriendsFragmentModule.class,
  ...
  @Subcomponent() public interface SplashSubcomponent
      extends AndroidInjector<com.qingchengfit.fitcoach.activity.SplashActivity> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<com.qingchengfit.fitcoach.activity.SplashActivity> {
    }
  }

  @Subcomponent() public interface ChatChooseInGymFragmentSubcomponent
  ...
  @Subcomponent() public interface ChatFriendAllChooseFragmentSubcomponent
  ...
  @Subcomponent() public interface MainMsgFragmentSubcomponent
      extends AndroidInjector<MainMsgFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<MainMsgFragment> {
    }
  }

  @Subcomponent() public interface ContainerSubcomponent
  ...
  @Subcomponent() public interface SaleDetailFragmentSubcomponent
  ...
  @Subcomponent() public interface SalerChooseDialogFragmentSubcomponent
  ...
  @Subcomponent() public interface StatementDetailFragmentSubcomponent
  ...
  @Subcomponent() public interface ManageFragmentSubcomponent
      extends AndroidInjector<ManageFragment> {
    @Subcomponent.Builder public abstract class Builder
  ...
  @Subcomponent() public interface BaseDialogFragmentSubcomponent
      extends AndroidInjector<BaseDialogFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<BaseDialogFragment> {
    }
  }

  @Subcomponent() public interface CustomSaleFragmentSubcomponent
  ...
  @Subcomponent() public interface Main2Subcomponent extends AndroidInjector<Main2Activity> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<Main2Activity> {
    }
  }

  @Subcomponent() public interface UnLoginHomeFragmentSubcomponent
      extends AndroidInjector<UnLoginHomeFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<UnLoginHomeFragment> {
    }
  }

  @Subcomponent() public interface HomeBannerFragmentSubcomponent
      extends AndroidInjector<HomeBannerFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<HomeBannerFragment> {
    }
  }

  @Subcomponent() public interface UnloginManageFragmentSubcomponent
      extends AndroidInjector<UnloginManageFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<UnloginManageFragment> {
    }
  }

  @Subcomponent() public interface MineFragmentFragmentSubcomponent
      extends AndroidInjector<MineFragmentFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<MineFragmentFragment> {
    }
  }

  @Subcomponent() public interface SyncGymFragmentSubcomponent
      extends AndroidInjector<SyncGymFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<SyncGymFragment> {
    }
  }

  @Subcomponent() public interface SettingFragmentSubcomponent
      extends AndroidInjector<SettingFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<SettingFragment> {
    }
  }

  @Subcomponent() public interface UnLoginScheduleAdFragmentSubcomponent
      extends AndroidInjector<UnLoginScheduleAdFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<UnLoginScheduleAdFragment> {
    }
  }

  @Subcomponent() public interface MainScheduleFragmentSubcomponent
      extends AndroidInjector<MainScheduleFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<MainScheduleFragment> {
    }
  }

  @Subcomponent() public interface GuideSetGymFragmentSubcomponent
      extends AndroidInjector<GuideSetGymFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<GuideSetGymFragment> {
    }
  }
  ...
  @Module(subcomponents = ConversationFriendsFragmentSubcomponent.class)
  abstract class ConversationFriendsFragmentModule {
  ...
  @Module(subcomponents = ChatChooseInGymFragmentSubcomponent.class)
  abstract class ChatChooseInGymFragmentModule {
    @Binds @IntoMap @FragmentKey(ChatChooseInGymFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        ChatChooseInGymFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = ChatFriendAllChooseFragmentSubcomponent.class)
  abstract class ChatFriendAllChooseFragmentModule {
  ...
  @Module(subcomponents = MainMsgFragmentSubcomponent.class) abstract class MainMsgFragmentModule {
    ...
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        MainMsgFragmentSubcomponent.Builder builder);
  }
  ...
  @Module(subcomponents = ContainerSubcomponent.class) abstract class ContainerModule {
    ...
    abstract AndroidInjector.Factory<? extends Activity> bindYourFragmentInjectorFactory(
        ContainerSubcomponent.Builder builder);
  }
  ...
  @Module(subcomponents = SaleDetailFragmentSubcomponent.class)
  abstract class SaleDetailFragmentModule {
    @Binds @IntoMap @FragmentKey(SaleDetailFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        SaleDetailFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = SalerChooseDialogFragmentSubcomponent.class)
  abstract class SalerChooseDialogFragmentModule {
    @Binds @IntoMap @FragmentKey(SalerChooseDialogFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        SalerChooseDialogFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = StatementDetailFragmentSubcomponent.class)
  abstract class StatementDetailFragmentModule {
  ...
  abstract class CustomStatmentFragmentModule {
  ...
  abstract class BaseDialogFragmentModule {
    @Binds @IntoMap @FragmentKey(BaseDialogFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        BaseDialogFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = CustomSaleFragmentSubcomponent.class)
  abstract class CustomSaleFragmentModule {
  ...
  @Module(subcomponents = Main2Subcomponent.class) abstract class Main2Module {
    ...
    abstract AndroidInjector.Factory<? extends Activity> bindYourFragmentInjectorFactory(
        Main2Subcomponent.Builder builder);
  }

  @Module(subcomponents = UnLoginHomeFragmentSubcomponent.class)
  abstract class UnLoginHomeFragmentModule {
    @Binds @IntoMap @FragmentKey(UnLoginHomeFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        UnLoginHomeFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = HomeBannerFragmentSubcomponent.class)
  abstract class HomeBannerFragmentModule {
    @Binds @IntoMap @FragmentKey(HomeBannerFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        HomeBannerFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = UnloginManageFragmentSubcomponent.class)
  abstract class UnloginManageFragmentModule {
    @Binds @IntoMap @FragmentKey(UnloginManageFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        UnloginManageFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = MineFragmentFragmentSubcomponent.class)
  abstract class MineFragmentFragmentModule {
  ...
  @Module(subcomponents = SyncGymFragmentSubcomponent.class) abstract class SyncGymFragmentModule {
    ...
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        SyncGymFragmentSubcomponent.Builder builder);
  }
  ...
  @Module(subcomponents = UnLoginScheduleAdFragmentSubcomponent.class)
  abstract class UnLoginScheduleAdFragmentModule {
    @Binds @IntoMap @FragmentKey(UnLoginScheduleAdFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        UnLoginScheduleAdFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = MainScheduleFragmentSubcomponent.class)
  abstract class MainScheduleFragmentModule {
    @Binds @IntoMap @FragmentKey(MainScheduleFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        MainScheduleFragmentSubcomponent.Builder builder);
  }

  @Module(subcomponents = GuideSetGymFragmentSubcomponent.class)
  abstract class GuideSetGymFragmentModule {
  ...
  @Subcomponent() public interface MyCoursePlanFragmentSubcomponent
      extends AndroidInjector<MyCoursePlanFragment> {
    @Subcomponent.Builder public abstract class Builder
        extends AndroidInjector.Builder<MyCoursePlanFragment> {
    }
  }

  @Module(subcomponents = MyCoursePlanFragmentSubcomponent.class)
  abstract class MyCoursePlanFragmentModule {
    @Binds @IntoMap @FragmentKey(MyCoursePlanFragment.class)
    abstract AndroidInjector.Factory<? extends Fragment> bindYourFragmentInjectorFactory(
        MyCoursePlanFragmentSubcomponent.Builder builder);
  }

  @Subcomponent() public interface ChooseGymTrainerFragmentSubcomponent
      extends AndroidInjector<com.qingchengfit.fitcoach.fragment.manage.ChooseGymFragment> {
    @Subcomponent.Builder public abstract class Builder extends
        AndroidInjector.Builder<com.qingchengfit.fitcoach.fragment.manage.ChooseGymFragment> {
    }
  }

  @Module(subcomponents = ChooseGymTrainerFragmentSubcomponent.class)
  abstract class ChooseGymTrainerFragmentModule {
