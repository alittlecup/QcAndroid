 ...
 */
public class StudentCardAdapter extends RecyclerView.Adapter<StudentCardAdapter.CardViewHolder> implements View.OnClickListener {
    ...
    @Override public CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CardViewHolder holder =
            new CardViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_student_cart, parent, false));
