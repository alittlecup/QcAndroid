...
// * <ul>
// * <li>Supports all RecyclerView LayoutManagers that implement (Linear, Grid or
// * StaggeredGrid).</li>
...
// */
//@SuppressWarnings({ "WeakerAccess" }) public class FlexibleItemDecoration
...
//      return;
//    }
//    if (getOrientation(parent) == RecyclerView.VERTICAL) {
...
//   * @since 5.0.0-rc2
//   */
//  public FlexibleItemDecoration addItemViewType(@LayoutRes int viewType, int left, int top,
...
//   * @since 5.0.0-rc2
//   */
//  @Override public void getItemOffsets(final Rect outRect, View view, RecyclerView recyclerView,
...
//  }
//
//  @NonNull private ItemDecoration getItemDecoration(int itemType) {
...
//  }
//
//  private boolean isFirstRowOrColumn(int position, RecyclerView.Adapter adapter, int spanIndex,
//      int itemType) {
...
//  }
//
//  private boolean isLastRowOrColumn(int position, RecyclerView.Adapter adapter, int spanIndex,
//      int spanCount, int spanSize, int itemType) {
...
//  private void applySectionGap(Rect outRect, RecyclerView.Adapter adapter, int position,
//      int orientation) {
//    // Section Gap Offset
...
//      if (item instanceof ISectionable && (flexibleAdapter.isHeader(
//          flexibleAdapter.getItem(position + 1)) || position >= adapter.getItemCount() - 1)) {
//
