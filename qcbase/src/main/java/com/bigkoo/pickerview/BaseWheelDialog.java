...
public class BaseWheelDialog extends Dialog implements View.OnClickListener {
  private static final String TAG_SUBMIT = "submit";
  private static final String TAG_CANCEL = "cancel";
  WheelOptions wheelOptions;
  protected View rootView; // 总的布局
  private View btnSubmit, btnCancel;
  private BaseWheelDialog.OnOptionsSelectListener optionsSelectListener;

  public BaseWheelDialog(Context context) {
    super(context, R.style.ChoosePicDialogStyle);
    LayoutInflater mLayoutInflater = LayoutInflater.from(context);
    rootView = mLayoutInflater.inflate(getLayoutId(), null);
    // -----确定和取消按钮
    btnSubmit = rootView.findViewById(R.id.btn_comfirm);
  ...
  protected int getLayoutId() {
    return R.layout.base_wheel_dialog;
  }
  ...
  public void setOnoptionsSelectListener(
      BaseWheelDialog.OnOptionsSelectListener optionsSelectListener) {
