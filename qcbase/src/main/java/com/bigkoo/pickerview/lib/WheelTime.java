...
public class WheelTime {
  ...
  public void setPicker(int year, int month, int day, int h, int m) {
    ...
    wv_today = view.findViewById(R.id.today);
    ArrayList<String> arr = new ArrayList<>();
    arr.add("今日");
    arr.add("次日");
    wv_today.setAdapter(new ArrayWheelAdapter<String>(arr, 4));
    ...
    switch (type) {
      case ALL:
        ...
        wv_today.setVisibility(View.GONE);
        break;
      case YEAR_MONTH:
      ...
      case HOURS_MINS:
        ...
        wv_today.setVisibility(View.GONE);
        break;
      case TODAY_HOURS_MINS:
        textSize = (screenheight / 150) * 4;
        wv_hours.setCyclic(true);
        wv_mins.setCyclic(true);
        wv_today.setVisibility(View.VISIBLE);
        wv_year.setVisibility(View.GONE);
        wv_month.setVisibility(View.GONE);
        wv_day.setVisibility(View.GONE);
        break;
    ...
    wv_today.TEXT_SIZE = textSize;
  }

  public void setPicker(int year, int month, int day, int h, int m, int interval) {
    // 添加大小月月份并将其转换为list,方便之后的判断
    String[] months_big = { "1", "3", "5", "7", "8", "10", "12" };
    String[] months_little = { "4", "6", "9", "11" };
  ...
  public String getTime() {
    ...
    sb.append((wv_year.getCurrentItem() + START_YEAR))
      ...
      .append(":")
      .append(wv_mins.getCurrentItem() * interval);
    return sb.toString();
  }

  public TimePopupWindow.Type getType() {
    return type;
  }

  public boolean isToday() {
    if (wv_today.getVisibility() == View.VISIBLE) {
      return wv_today.getCurrentItem() == 0;
    }
    return true;
  }
}
