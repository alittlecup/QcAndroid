...
public class TabItem extends View {
  ...
  private void initText() {
    ...
    mTextPaintNormal.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mTextSize,
    ...
    mTextPaintSelect.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mTextSize,
        getResources().getDisplayMetrics()));
  ...
  private void drawText(Canvas canvas) {
    ...
    canvas.drawText(mTextNormal, x, y, mTextPaintNormal);
    canvas.drawText(mTextSelect, x, y, mTextPaintSelect);
    canvas.drawBitmap(mIconCircle, ((mViewWidth / 2) + (mIconNormal.getWidth() / 2)) + 5,
        MeasureUtils.dpToPx(5f, getResources()), mIconPaintCircle);
  }
  ...
  public void setIconText(int[] iconSelId, String[] textValue) {
    ...
    this.mTextSelect = textValue[0];
    this.mTextNormal = textValue[1];
    mTextValue = mTextNormal;
  }
