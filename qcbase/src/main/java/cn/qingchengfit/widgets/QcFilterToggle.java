...
public class QcFilterToggle extends CompoundButton implements QcCheckable {
  ...
  public QcFilterToggle(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    final TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.QcFilterToggle, defStyleAttr, 0);
    ...
    a.recycle();
    if (buttonDrawableOn != null) DrawableCompat.setTint(buttonDrawableOn, colorOn);
    if (buttonDrawableOff != null) DrawableCompat.setTint(buttonDrawableOff, colorOff);
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    if (textLenth > getWidth() - MeasureUtils.dpToPx(20f, getResources()) - (
      ...
      int ind =
          (int) ((getWidth() - MeasureUtils.dpToPx(20f, getResources()) - (buttonDrawableOn == null
              ? 0 : buttonDrawableOn.getIntrinsicWidth())) / textLenth * txt.length());
    ...
    if (mChecked && buttonDrawableOn != null) {
      ...
      if (top < 0) top = 0;
      buttonDrawableOn.setBounds((int) (leftText + textLenth + 10), top,
          (int) (leftText + textLenth + 10 + drawableWidth), top + drawableHeight);
      ...
      int top = canvas.getHeight() / 2 - drawableHeight / 2;
      if (top < 0) top = 0;
      buttonDrawableOff.setBounds((int) (leftText + textLenth + 10), top,
          (int) (leftText + textLenth + 10 + drawableWidth), top + drawableHeight);
