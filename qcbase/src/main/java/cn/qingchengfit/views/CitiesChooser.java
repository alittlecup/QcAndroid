...
public class CitiesChooser {
    ...
    public CitiesChooser(Context context) {
        ...
        pwOptions.setOnoptionsSelectListener(new BaseWheelDialog.OnOptionsSelectListener() {
