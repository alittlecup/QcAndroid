...
public class QcTagView extends View {
   ...
   */
  public void setItemDrawableStates(@Nullable Drawable d0, @Nullable Drawable d1,
      @Nullable Drawable d2) {
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    setMeasuredDimension(
        mHorizontalPadding * 2 + (int) fontW + getPaddingRight() + getIntPadding() * 2 + 1,
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    if (!useDrawable) {
      ...
      if (isFlag_on()) {
        background_drawable_1.setBounds((int) mRectF.left, (int) mRectF.top, (int) mRectF.right,
            (int) mRectF.bottom);
        background_drawable_1.draw(canvas);
      } else {
        background_drawable_0.setBounds((int) mRectF.left, (int) mRectF.top, (int) mRectF.right,
            (int) mRectF.bottom);
    ...
    if (mTextDirection == View.TEXT_DIRECTION_RTL) {
      ...
      canvas.drawText(mAbstractText,
          getWidth() / 2 - fontW / 2 - getIntPadding() - getPaddingRight() / 2,
