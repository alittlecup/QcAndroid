...
public class MyMarkerView extends MarkerView {
  ...
  @Override public void refreshContent(Entry e, Highlight highlight) {
    ...
    if (e instanceof CandleEntry) {
      ...
      tvContent.setText(new StringBuilder().append(StudentBusinessUtils.getNumString(ce.getHigh()))
          .append(strUnit)
          .toString());
      tvContent.setText(String.format(getResources().getString(R.string.markview_count_unit),
          StudentBusinessUtils.getNumString(ce.getHigh()), strUnit));
    } else {
      tvDate.setText((String) e.getData());
      tvContent.setText(String.format(getResources().getString(R.string.markview_count_unit),
          StudentBusinessUtils.getNumString(e.getY()), strUnit));
    }
