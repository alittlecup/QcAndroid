...
public final class RxHelper {
  ...
  public static <T> Observable.Transformer<T, T> schedulersTransformer() {
    return observable -> observable.onBackpressureBuffer()
        .subscribeOn(Schedulers.io())
        .observeOn(AndroidSchedulers.mainThread());
  }

  public static <T> Observable.Transformer<T, T> schedulersClickTransformer() {
    return observable -> observable.throttleFirst(500, TimeUnit.MILLISECONDS)
        .observeOn(AndroidSchedulers.mainThread());
  }
