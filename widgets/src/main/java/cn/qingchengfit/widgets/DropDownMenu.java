...
/**
 * power by
 * https://github.com/dongjunkun/DropDownMenu/blob/master/library/src/main/java/com/yyydjk/library/DropDownMenu.java
 */
...
public class DropDownMenu extends LinearLayout {
  ...
  public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews,
    ...
    popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        (int) (MeasureUtils.getScreenHeight(getContext().getResources()) * menuHeighPercent)));
        ...
        if (current_tab_position == i) {
          ...
          if (current_tab_position == -1) {
            ...
            popupMenuViews.setAnimation(
                AnimationUtils.loadAnimation(getContext(), R.anim.slide_top_in));
