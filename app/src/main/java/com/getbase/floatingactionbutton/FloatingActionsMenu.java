...
public class FloatingActionsMenu extends ViewGroup {
    ...
    public void addButton(Button button) {
        ViewGroup.LayoutParams layoutParamsOOO = new ViewGroup.LayoutParams(MeasureUtils.dpToPx(130f, getResources()), MeasureUtils.dpToPx(48f, getResources()));
//    layoutParams.bottomMargin = 20;
        LayoutParams layoutParams = new LayoutParams(layoutParamsOOO);
        layoutParams.bottomMargin = 20;
        addView(button, mButtonsCount - 1, layoutParams);
...
//      int addButtonLeft = buttonsHorizontalCenter - mAddButton.getMeasuredWidth() / 2;
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    params.width = MeasureUtils.dpToPx(130f, getResources());
                    params.height = MeasureUtils.dpToPx(48f, getResources());
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            addView(label, new ViewGroup.LayoutParams(MeasureUtils.dpToPx(130f, getResources()), ViewGroup.LayoutParams.MATCH_PARENT));
