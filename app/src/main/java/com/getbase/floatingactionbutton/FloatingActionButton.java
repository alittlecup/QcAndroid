...
public class FloatingActionButton extends ImageButton {
    ...
    public void setCustomBackground(int bgres) {
        mCustomBg = bgres;
        updateBackground();
    }
    ...
    void updateBackground() {
        ...
        if (mCustomBg == 0) {
            layerDrawable = new LayerDrawable(
                    new Drawable[]{
                            getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.fab_bg_mini : R.drawable.fab_bg_normal),
            ...
            layerDrawable = new LayerDrawable(
                    new Drawable[]{
                            getResources().getDrawable(mCustomBg),
                            createFillDrawable(strokeWidth),
                            createOuterStrokeDrawable(strokeWidth),
                            getIconDrawable()
                    });
