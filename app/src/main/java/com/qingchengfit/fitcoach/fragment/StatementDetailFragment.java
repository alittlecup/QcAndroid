...
public class StatementDetailFragment extends BaseFragment implements StatementDetailView, OnRecycleItemClickListener {
    ...
    public static StatementDetailFragment newInstance(int type, String starttime, String endtime, String model, long sysId,
    ...
    @Override public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == RESULT_FILTER && data != null) {
    ...
    private void filter() {
        ...
        for (int i = 0; i < mAllSchedule.size(); i++) {
            ...
            if ((mFilter.course_type < 0
                || (mFilter.course_type == Configs.TYPE_PRIVATE && statamentSchedule.course.is_private())
    ...
    @Override public void onItemClick(View v, int pos) {
        getFragmentManager().beginTransaction()
            .replace(R.id.web_frag_layout, CourseReverseFragmentBuilder.newCourseReverseFragment(statementBeans.get(pos).id))
            .addToBackStack(null)
            .commit();
    }
        ...
        @Override public void onBindViewHolder(StatementDetailVH holder, int position) {
            ...
            if (bean.orders != null) {
                for (int i = 0; i < bean.orders.size(); i++) {
                    ...
                    users = users.concat(TextUtils.isEmpty(users) ? "" : "、").concat(bean.orders.get(i).user.username);
                    //                    } else {
