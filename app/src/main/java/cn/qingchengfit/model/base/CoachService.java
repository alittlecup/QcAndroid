...
public class CoachService implements Parcelable, CoachServiceModel {
    ...
    @Nullable @Override public QcCoachRespone.DataEntity.CoachEntity.DistrictEntity gd_district() {
        return null;
    }
    ...
    public static final ColumnAdapter<QcCoachRespone.DataEntity.CoachEntity.DistrictEntity, String> gd_districtAdapter =
        new ColumnAdapter<QcCoachRespone.DataEntity.CoachEntity.DistrictEntity, String>() {
            Gson gson = new Gson();

            @NonNull @Override public QcCoachRespone.DataEntity.CoachEntity.DistrictEntity decode(String s) {
                return gson.fromJson(s, QcCoachRespone.DataEntity.CoachEntity.DistrictEntity.class);
            }

            @Override public String encode(@NonNull QcCoachRespone.DataEntity.CoachEntity.DistrictEntity districtEntity) {
                return gson.toJson(districtEntity, QcCoachRespone.DataEntity.CoachEntity.DistrictEntity.class);
            }
        };
    ...
    public static final Factory<CoachService> FACTORY = new Factory<>(new CoachServiceModel.Creator<CoachService>() {
        @Override public CoachService create(@Nullable String id, @Nullable String model, @Nullable String gym_id, @Nullable Integer type,
            ...
            @Nullable QcCoachRespone.DataEntity.CoachEntity.DistrictEntity gd_district) {
