...
public class DividerItemDecorationChatChooseInGym extends RecyclerView.ItemDecoration {
     ...
     * @since 5.0.0-b4
     */
    public DividerItemDecorationChatChooseInGym(Context context) {
     ...
     * @since 5.0.0-b8
     */
    public DividerItemDecorationChatChooseInGym withDrawOver(boolean drawOver) {
     ...
     */
    public DividerItemDecorationChatChooseInGym setDrawOver(boolean drawOver) {
     ...
     * @since 5.0.0-b8
     */
    public DividerItemDecorationChatChooseInGym withOffset(boolean withOffset) {
