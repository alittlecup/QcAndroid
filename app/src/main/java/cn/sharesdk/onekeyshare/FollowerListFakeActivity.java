		...
		if ("SinaWeibo".equals(platformName)) {
			...
			for (HashMap<String, Object> user : users) {
				...
				if (!uidMap.containsKey(uid)) {
					...
					following.uid = uid;
					following.screenName = String.valueOf(user.get("username"));
			...
			for (HashMap<String, Object> d : datas) {
				...
				if (!uidMap.containsKey(uid)) {
					...
					following.uid = uid;
					following.atName = "["+uid+"]";
					following.screenName = String.valueOf(d.get("username"));
					@SuppressWarnings("unchecked")
			...
			// users[screen_name, username, description]
			@SuppressWarnings("unchecked")
			ArrayList<HashMap<String, Object>> users
					= (ArrayList<HashMap<String,Object>>) res.get("users");
			for (HashMap<String, Object> user : users) {
