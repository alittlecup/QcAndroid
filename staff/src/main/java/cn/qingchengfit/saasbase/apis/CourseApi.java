...
public interface CourseApi {
  ...
  //获取某个排期的详情
  @GET("/api/staffs/{id}/batches/{batch_id}/") rx.Observable<QcDataResponse<BatchDetailWrap>> qcGetBatchDetail(@Path("id") String staff_id,
    @Path("batch_id") String batch_id, @QueryMap HashMap<String,Object> params);


  //获取教练排期
  @GET("/api/staffs/{id}/coaches/{coach_id}/batches/?course__is_private=1") rx.Observable<QcDataResponse<QcResponsePrivateDetail>> qcGetPrivateCoaches(
    @Path("id") String staff_id, @Path("coach_id") String coach_id, @QueryMap HashMap<String, Object> params);

  //获取团课排期
  @GET("/api/staffs/{id}/courses/{course_id}/batches/") rx.Observable<QcDataResponse<GroupCourseScheduleDetail>> qcGetGroupCourses(
    @Path("id") String staff_id, @Path("course_id") String course_id, @QueryMap HashMap<String, Object> params);
  ...
  rx.Observable<QcDataResponse<BatchSchedulesWrap>> qcGetbatchSchedules(@Path("staff_id") String staff_id, @Path("batch_id") String batch_id,
  ...
  @GET("/api/staffs/{id}/{type}/arrange/template/") rx.Observable<QcDataResponse<ScheduleTemplete>> qcGetBatchTemplate(
    ...
    @Query("teacher_id") String teacher_id, @Query("course_id") String course_id,@QueryMap HashMap<String,Object> params);

  @GET("/api/v2/staffs/{staff_id}/courses/photos/") rx.Observable<QcDataResponse<JacketPhotoWrap>> qcGetJacket(
   ...
   * 获取课程下教练
   */
  @GET("/api/v2/staffs/{staff_id}/courses/teachers/") rx.Observable<QcDataResponse<CourseTeacherWrapper>> qcGetCourseTeacher(
    @Path("staff_id") String staff_id, @Query("course_id") String id, @QueryMap HashMap<String, Object> params);

  /**
   * 课程下照片
   */
  @GET("/api/v2/staffs/{staff_id}/courses/schedules/photos/") rx.Observable<QcDataResponse<SchedulePhotoListWrap>> qcGetSchedulePhotos(
   ...
   * 获取课程详情
   */
  @GET("/api/v2/staffs/{staff_id}/courses/") rx.Observable<QcDataResponse<CourseTypeWrap>> qcGetCourseDetail(
    @Path("staff_id") String staff_id, @Query("course_id") String id, @QueryMap HashMap<String, Object> params);

  /**
   * 分场馆评分
   */
  @GET("/api/v2/staffs/{staff_id}/courses/shops/score/") rx.Observable<QcDataResponse<ShopCommentWrap>> qcGetShopComment(
    @Path("staff_id") String staff_id, @Query("course_id") String id, @QueryMap HashMap<String, Object> params);
  ...
  @POST("/api/v2/staffs/{id}/courses/") rx.Observable<QcDataResponse> qcCreateCourse(@Path("id") String staffid, @Body
    CourseBody courseBody,
    @QueryMap HashMap<String, Object> params);

  //修改课程
  @PUT("/api/v2/staffs/{id}/courses/{course_id}/") rx.Observable<QcDataResponse> qcUpdateCourse(@Path("id") String staffid,
    @Path("course_id") String course_id, @QueryMap HashMap<String, Object> params, @Body
    CourseBody courseBody);

  //删除课程
  @DELETE("/api/v2/staffs/{id}/courses/{course_id}/") rx.Observable<QcDataResponse> qcDelCourse(@Path("id") String staffid,
    @Path("course_id") String course_id, @QueryMap HashMap<String, Object> params);

  //修改封面
  @POST("/api/v2/staffs/{id}/courses/photos/") rx.Observable<QcDataResponse> qcEditJacket(@Path("id") String staffid,
    @Query("course_id") String course_id, @QueryMap HashMap<String, Object> params, @Body
    EditJacketBody body);

  //修改课程适用场馆
  @PUT("/api/v2/staffs/{staff_id}/courses/{course_id}/shops/") rx.Observable<QcDataResponse> qcEditCourseShops(
  ...
  rx.Observable<cn.qingchengfit.network.response.QcDataResponse<SingleBatchWrap>> qcGetSingleBatch(@Path("id") String id,
    @Path("type") String type, @Path("single_id") String single_id, @QueryMap HashMap<String, Object> params);



  @POST("/api/staffs/{id}/arrange/batches/") rx.Observable<QcDataResponse> qcArrangeBatch(@Path("id") String staff_id,
     @Body ArrangeBatchBody body,@QueryMap HashMap<String, Object> params);

  @PUT("/api/staffs/{id}/batches/{batchid}/") rx.Observable<QcDataResponse> qcUpdateBatch(@Path("id") String staff_id,
    @Path("batchid") String batchid, @Body ArrangeBatchBody body,@QueryMap HashMap<String, Object> params);

  @POST("/api/staffs/{id}/{type}/arrange/check/") rx.Observable<QcDataResponse> qcCheckBatch(@Path("id") String staff_id,
    @Path("type") String type,  @Body ArrangeBatchBody body,@QueryMap HashMap<String, Object> params);

  //删除排期
  @POST("api/staffs/{id}/{type}/bulk/delete/") rx.Observable<QcDataResponse> qcDelBatchSchedule(@Path("id") String staff_id,
    @Path("type") String type, @Body DelBatchScheduleBody body,@QueryMap HashMap<String, Object> params);

  @DELETE("/api/staffs/{id}/batches/{batch_id}/") rx.Observable<QcDataResponse> delBatch(@Path("id") String staff_id,
    @Path("batch_id") String batch_id, @QueryMap HashMap<String, Object> paras);

  @PUT("api/staffs/{id}/{type}/{scheduleid}/") rx.Observable<QcDataResponse> qcUpdateBatchSchedule(@Path("id") String staff_id,
    @Path("type") String type, @Path("scheduleid") String scheduleid, @Body SingleBatchBody body,@QueryMap HashMap<String, Object> params);

  //复制排期检查课程冲突
  @POST("/api/staffs/{staff_id}/copy-batch/check/") rx.Observable<QcDataResponse> qcCheckBatchConflict(
      @Path("staff_id") String staff_id, @Body BatchCopyBody body, @QueryMap HashMap<String, Object> params);
  ...
  rx.Observable<QcDataResponse<CopyScheduleWrapper>> qcBatchCopySchedule(@Path("staff_id") String staff_id,
      @QueryMap HashMap<String, Object> params);
