...
public interface CardApi {
  ...
  @GET("api/staffs/{id}/balance/cards/")
  rx.Observable<QcDataResponse<CardListWrap>> qcGetBalanceCard(@Path("id") String staffid,
      @QueryMap HashMap<String, Object> params);
  ...
  @PUT("/api/staffs/{id}/options/{option_id}/") rx.Observable<QcDataResponse> qcUpdateCardtplOption(
      @Path("id") String staffid, @Path("option_id") String option_id,
      @QueryMap HashMap<String, Object> params, @Body OptionBody body);
  ...
  @PUT("/api/staffs/{staff_id}/cardtpls/{cardtpl_id}/shops/")
  rx.Observable<QcDataResponse> qcFixGyms(@Path("staff_id") String staffid,
      @Path("cardtpl_id") String card_tpl, @Body ShopsBody body,
      @QueryMap HashMap<String, Object> params);

  //充值扣费
  @POST("/api/staffs/{staff_id}/cards/{card_id}/charge/v2/")
  rx.Observable<QcDataResponse<JsonObject>> qcCardCharge(@Path("staff_id") String staff_id,
  ...
  rx.Observable<QcDataResponse<cn.qingchengfit.saasbase.cards.network.response.BalanceConfigs>> qcGetBalanceCondition(
      @Path("id") String staffId, @QueryMap HashMap<String, Object> params,
      @Query("keys") String permission);
  ...
  //暂存添加会员卡种类信息
  @POST("api/staffs/{staff_id}/cache/") rx.Observable<QcDataResponse<UUIDModel>> qcStashNewCardTpl(
      @Path("staff_id") String staff_id, @Body CardtplBody body,
      @QueryMap HashMap<String, Object> params);

  //新增请假
  @POST("/api/staffs/{id}/leaves/") rx.Observable<QcDataResponse> qcAddDayOff(
  ...
  //取消请假
  @DELETE("/api/staffs/{id}/leaves/{leave_id}/") rx.Observable<QcDataResponse> qcDelDayOff(
  ...
  //提前销假
  @PUT("/api/staffs/{staffid}/leaves/{leave_id}/") rx.Observable<QcDataResponse> qcAheadDayOff(
  ...
  //销卡
  @DELETE("/api/staffs/{id}/cards/{card_id}/") rx.Observable<QcDataResponse> qcUnregisteCard(
  ...
  //卡修改有效期
  @PUT("/api/staffs/{id}/cards/{card_id}/change-date/")
  rx.Observable<QcDataResponse> qcUndateCardValid(@Path("id") String staffid,
      @Path("card_id") String cardid, @QueryMap HashMap<String, Object> params,
      @Body UpdateCardValidBody body);

  //恢复卡
  @POST("/api/staffs/{id}/cards/{card_id}/recovery/") rx.Observable<QcDataResponse> qcResumeCard(
      @Path("id") String staffid, @Path("card_id") String cardid,
      @Query("brand_id") String brand_id, @Query("id") String id, @Query("model") String model);

  //获取消费记录
  @GET("/api/staffs/{id}/cards/{card_id}/histories/?order_by=-created_at")
  rx.Observable<QcDataResponse<QcResponseRealcardHistory>> qcGetCardhistory(
      @Path("id") String staffid, @Path("card_id") String card_id,
      @QueryMap HashMap<String, Object> params, @Query("created_at__gte") String start,
      @Query("created_at__lte") String end, @Query("page") int page);
