...
public class StudentsChooseDialogFragment extends BaseDialogFragment implements StudentChooseView {
      ...
      //mCallback.getFilterComponent().inject(this);
        ...
        adapter.setListener(new OnRecycleItemClickListener() {
            @Override public void onItemClick(View v, int pos) {
                if (students != null && students.size() > pos) {
                    mCallback.setStudent(students.get(pos));
                }
            }
        });
    ...
    @Override public void onAttach(Context context) {
        ...
        mCallback = (ClassStatmentFilterCallback) context;
    }
    ...
    @Override public void onCoaches(List<QcStudentBean> students) {
        ...
        for (int i = 0; i < students.size(); i++) {
            stringList.add(students.get(i).getUsername());
        }
