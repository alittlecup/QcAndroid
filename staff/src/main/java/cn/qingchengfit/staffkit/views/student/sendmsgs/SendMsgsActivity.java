...
public class SendMsgsActivity extends BaseActivity implements FragCallBack {

    @Override protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_send_msgs);
        getSupportFragmentManager().beginTransaction().replace(R.id.frag, new SendMsgHomeFragment()).commit();
    }
