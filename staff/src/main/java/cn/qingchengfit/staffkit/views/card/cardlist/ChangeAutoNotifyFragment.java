...
public class ChangeAutoNotifyFragment extends BaseFragment implements ChangeAutoNotifyPresenter.OnGetNotifySettingListener {
    ...
    @BindView(R.id.sw_store_notify) SwitcherLayout swStoreNotify;
    @BindView(R.id.sw_second_notify) SwitcherLayout swSecondNotify;
    @BindView(R.id.sw_time_notify) SwitcherLayout swTimeNotify;
    @BindView(R.id.text_store_condition) EditText textStoreValue;
    @BindView(R.id.text_second_condition) EditText textSecondValue;
    @BindView(R.id.text_time_condition) EditText textTimeValue;
