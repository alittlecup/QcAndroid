...
@FragmentWithArgs public class StudentFilterFragment extends BaseFragment {
  ...
  public TextView tvStudentFilterTimeStart;
  public TextView tvStudentFilterTimeEnd;
  public LinearLayout layoutFilterBirthday;
  public QcRadioGroup qrgStatus;
  public QcRadioGroup qrgRegistTimes;
  public LinearLayout layoutSaler;
  protected ImageView imgSalersAll;
  protected StudentFilter filter = new StudentFilter();
  protected TextView tvStudentBirthdayStart;
  protected TextView tvStudentBirthdayEnd;
  protected CheckBoxButton cbbGenderMale;
  protected CheckBoxButton cbbGenderFemale;
  protected Date start;
  protected Date end;
  protected int timePosition = -1;
  CheckBoxButton tvStudentFilterStatus0;
  CheckBoxButton tvStudentFilterStatus1;
  CheckBoxButton tvStudentFilterStatus2;
  ImageView imgReferrerShowall;
  ImageView imgSourceShowall;
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    layoutFilterBirthday = (LinearLayout) view.findViewById(R.id.layout_filter_birthday);
    qrgStatus = (QcRadioGroup) view.findViewById(R.id.qrg_status);
    qrgRegistTimes = (QcRadioGroup) view.findViewById(R.id.qrg_regitst_times);
    layoutSaler = (LinearLayout) view.findViewById(R.id.layout_saler);
    imgSalersAll = (ImageView) view.findViewById(R.id.img_saler_all);
    tvStudentBirthdayStart = (TextView) view.findViewById(R.id.tv_student_birthday_start);
    tvStudentBirthdayEnd = (TextView) view.findViewById(R.id.tv_student_birthday_end);
    cbbGenderMale = (CheckBoxButton) view.findViewById(R.id.cbb_gender_male);
    cbbGenderFemale = (CheckBoxButton) view.findViewById(R.id.cbb_gender_female);
    tvStudentFilterStatus0 = (CheckBoxButton) view.findViewById(R.id.tv_student_filter_status_0);
    tvStudentFilterStatus1 = (CheckBoxButton) view.findViewById(R.id.tv_student_filter_status_1);
    tvStudentFilterStatus2 = (CheckBoxButton) view.findViewById(R.id.tv_student_filter_status_2);
    imgReferrerShowall = (ImageView) view.findViewById(R.id.img_referrer_showall);
    imgSourceShowall = (ImageView) view.findViewById(R.id.img_source_showall);
    view.findViewById(R.id.tv_student_filter_referrer)
        .setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            onClickBtn(v);
          }
        });
    view.findViewById(R.id.tv_student_filter_source).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        onClickBtn(v);
      }
    });
    view.findViewById(R.id.img_source_showall).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        onClickBtn(v);
      }
    });
    view.findViewById(R.id.img_referrer_showall).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        onClickBtn(v);
      }
    });
    view.findViewById(R.id.tv_student_filter_reset).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        onClickBtn(v);
      }
    });
    view.findViewById(R.id.tv_student_filter_confirm)
        .setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            onClickBtn(v);
          }
        });
    view.findViewById(R.id.tv_saler_all).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        showAllSaler();
      }
    });
    view.findViewById(R.id.img_saler_all).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        showAllSaler();
      }
    });
    view.findViewById(R.id.tv_student_filter_time_start)
        .setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            onTimeClick(v);
          }
        });
    view.findViewById(R.id.tv_student_filter_time_end)
        .setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            onTimeClick(v);
          }
        });
    view.findViewById(R.id.tv_student_birthday_start)
        .setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            onClickBirthDay(v);
          }
        });
    view.findViewById(R.id.tv_student_birthday_end).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        onClickBirthDay(v);
      }
    });
  ...
  private void initView() {
    ...
    getChildFragmentManager().beginTransaction()
        .replace(R.id.frame_student_filter_referrer, referrerFragment)
        .commit();

    sourceFragment = new SourceFragmentBuilder(2).build();
    getChildFragmentManager().beginTransaction()
        .replace(R.id.frame_student_filter_source, sourceFragment)
        .commit();
    ...
    switch (view.getId()) {
      ...
      case R.id.img_referrer_showall:
        ...
        VectorDrawableCompat drawableR = VectorDrawableCompat.create(getResources(),
            isReferrerShowAll ? R.drawable.vector_arrow_up_grey : R.drawable.vector_arrow_down_grey,
            null);
      ...
      case R.id.img_source_showall:
        ...
        VectorDrawableCompat drawableS = VectorDrawableCompat.create(getResources(),
            isSourceShowAll ? R.drawable.vector_arrow_up_grey : R.drawable.vector_arrow_down_grey,
            null);
  ...
  protected void doReset() {
    ...
    //  // 关闭筛选页
    RxBus.getBus()
        .post(new StudentFilterEventBuilder().eventType(StudentFilterEvent.EVENT_RESET_CLICK)
            .filter(filter)
            .createStudentFilterEvent());
  }
  ...
  public void resetView(StudentFilter filter) {
    ...
    tvStudentFilterTimeStart.setText("");
    tvStudentFilterTimeEnd.setText("");
    if (!TextUtils.isEmpty(filter.registerTimeStart) && !TextUtils.isEmpty(
