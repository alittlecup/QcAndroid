...
public class GymCoursesPresenter implements Presenter {
    ...
    @Inject public GymCoursesPresenter(GymUseCase useCase, CoachService coachService) {
    ...
    public void queryData() {
        ...
        //                    for (QcResponseCourse.CourseTypeSample course : qcResponseCourse.data.shop.courses) {
        //
