...
public class LinearFunItem extends AbstractFlexibleItem<LinearFunItem.LinearFunVH> {
  ...
  @Override public void bindViewHolder(FlexibleAdapter adapter, LinearFunVH holder, int position,
      List payloads) {
    holder.imgFun.setImageDrawable(holder.imgFun.getResources().getDrawable(mGymFuntion.getImg()));
