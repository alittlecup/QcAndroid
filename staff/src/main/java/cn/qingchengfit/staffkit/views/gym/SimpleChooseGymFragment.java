 ...
 */
public class SimpleChooseGymFragment extends BaseDialogFragment {
    ...
    public static void start(Fragment fragment, boolean simple, ArrayList<String> chooseIds, int requestcode) {
        SimpleChooseGymFragment f = newInstance(simple, chooseIds);
        f.setTargetFragment(fragment, requestcode);
        f.show(fragment.getFragmentManager(), "");
    }

    public static SimpleChooseGymFragment newInstance(boolean simple, ArrayList<String> chooseIds) {

        Bundle args = new Bundle();
        args.putStringArrayList("ids", chooseIds);
        SimpleChooseGymFragment fragment = new SimpleChooseGymFragment();
