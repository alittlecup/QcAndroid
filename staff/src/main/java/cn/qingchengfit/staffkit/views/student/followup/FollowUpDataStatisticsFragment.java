...
@FragmentWithArgs public class FollowUpDataStatisticsFragment extends BaseFragment
    ...
    @BindView(R.id.frag_follow_up_filter_container) FrameLayout layoutBgHalfTrans;
        ...
        @Override public void onCheckedChanged(CompoundButton compoundButton, final boolean b) {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    if (!b) {
                        layoutParams.height =
                            (int) ((1 - (float) valueAnimator.getAnimatedValue()) * MeasureUtils.getScreenHeight(getResources()))
                        ...
                        layoutParams.height =
                            (int) ((float) valueAnimator.getAnimatedValue() * MeasureUtils.getScreenHeight(getResources()));
                        layoutBg.setLayoutParams(layoutParams);
                        getView().postInvalidateOnAnimation();
                    }
                }
    ...
    public FollowUpDataStatisticsFragment() {
        ...
        saleFragment.page = 0;
        latestTimeFragment = new FilterTimesFragmentBuilder(30, 0).build();//第一参数用于限制 最大日期区间为30天
        latestTimeFragment.page = 0;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        qftSaler.setOnCheckedChangeListener(filterListenr);
        qftTimes.setOnCheckedChangeListener(filterListenr);
    ...
    private void hideAll() {
        getChildFragmentManager().beginTransaction().hide(saleFragment).hide(latestTimeFragment).commitNowAllowingStateLoss();
    }

    private void initBus() {
        RxBusAdd(FollowUpFilterEvent.class).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1<FollowUpFilterEvent>() {
