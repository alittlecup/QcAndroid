...
public class StudentFilter implements Parcelable {
    ...
    public boolean isEmpty() {
        return StringUtils.isEmpty(status)
            && StringUtils.isEmpty(referrerId)
            && StringUtils.isEmpty(sourceId)
            && sourceBean == null
            && StringUtils.isEmpty(dayOff)
            && StringUtils.isEmpty(registerTimeEnd)
            && StringUtils.isEmpty(registerTimeStart)
            && StringUtils.isEmpty(birthdayStart)
            && StringUtils.isEmpty(birthdayEnd);
