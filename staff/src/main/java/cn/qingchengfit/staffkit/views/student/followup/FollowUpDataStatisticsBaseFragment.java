...
public abstract class FollowUpDataStatisticsBaseFragment extends BaseFragment
    ...
    @BindView(R.id.tv_total_count_lable) TextView tvTotalCountLable;
    @BindView(R.id.tv_total_count) TextView tvTotalCount;
    @BindView(R.id.start_day) TextView tvStartDay;
    @BindView(R.id.end_day) TextView tvEndDay;
    ...
    private void initView() {
        ...
        if (isAttendance) {
            MyMarkerView mv = new MyMarkerView(getActivity(), R.layout.custom_marker_view, getLineColor(), "人次");
            mv.setChartView(lineChart); // For bounds control
            lineChart.setMarker(mv); // Set the marker to the chart
        } else {
            MyMarkerView mv = new MyMarkerView(getActivity(), R.layout.custom_marker_view, getLineColor());
            mv.setChartView(lineChart); // For bounds control
            lineChart.setMarker(mv); // Set the marker to the chart
        }
    ...
    @Override public void onChartGestureStart(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
        Timber.e("onChartGestureStart:->:MotionEvent:->" + me + ";;ChartGesture:->" + lastPerformedGesture);
    }

    @Override public void onChartGestureEnd(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
        Timber.e("onChartGestureEnd:->:MotionEvent:->" + me + ";;ChartGesture:->" + lastPerformedGesture);
    }
