...
import static cn.qingchengfit.staffkit.R.id.img;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void updateTabStyles(int position) {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (tabTitle instanceof ImageView) {
                    if (tabNum instanceof TextView) {
                        ((TextView) tabNum).setTextColor(
                            CompatUtils.getColor(getContext(), i == position ? R.color.colorPrimary : R.color.text_black));
                    }
                }
            }
        }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            } else if (mViewPager.getAdapter() instanceof RedDotTabProvider) {
                addImageTab(i, (((RedDotTabProvider) mViewPager.getAdapter()).showRed(i)),
                    (((RedDotTabProvider) mViewPager.getAdapter()).getTextStr(i)));
    ...
    public interface RedDotTabProvider {
        String getTextStr(int position);

        boolean showRed(int position);
    }
