...
public class PasswordView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        // Load attributes
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PasswordView, defStyle, 0);
    ...
    public void toggle() {
        ...
        if (isPwMode) {
            ...
            mTvPw.setText(R.string.login_pw);
            mOpenEye.setVisibility(VISIBLE);
            mNum.setInputType(InputType.TYPE_CLASS_TEXT | (mOpenEye.isChecked() ? InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD
