 ...
 */
public class GymMoreFragment extends BaseFragment
    implements FlexibleAdapter.OnItemClickListener, GymMorePresenter.MVPView {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    leaveBtn = view.findViewById(R.id.btn_leave);
    ...
    leaveBtn.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        QuitGymFragment quitDialog = new QuitGymFragment();
        quitDialog.setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            mGymMorePresenter.queiteGym();
          }
        });
    ...
    myFunRecycleview.getViewTreeObserver()
        .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
          @Override public void onGlobalLayout() {
              ...
              @Override public boolean onItemClick(int position) {
                if (mFunAdapter.getItem(position) instanceof GymFuntionItem) {
                  if (mEditableMode) {
                    ...
                    for (int i = len; i >= 0; i--) {
                      if (mFunsDatas.get(i) instanceof GymFuntionItem) {
                        if (((GymFuntionItem) mFunsDatas.get(i)).getGymFuntion().getImg() == 0) {
                          mFunsDatas.remove(i);
                        }
                      }
                    }
                    ...
                    String moduleName =
                        ((GymFuntionItem) mFunAdapter.getItem(position)).getGymFuntion()
                            .getModuleName();

                    if (!gymWrapper.isPro() && GymFunctionFactory.getModuleStatus(moduleName) > 0) {
                      UpgradeInfoDialogFragment.newInstance(QRActivity.getIdentifyKey(moduleName))
                          .show(getFragmentManager(), "");
                      return true;
                    }
                    gymFunctionFactory.getJumpIntent(moduleName, gymWrapper.getCoachService(), null,
                        null, GymMoreFragment.this);
                  }
                }
                return true;
              }
            ...
            SmoothScrollGridLayoutManager layoutManager1 =
            ...
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_WORKSPACE_ORDER_LIST),
                workFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_WORKSPACE_GROUP),
                workFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_WORKSPACE_PRIVATE),
                workFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_WORKSPACE_ORDER_SIGNIN),
                workFuntion));
            mDatas.add(new GymFuntionItem(
            ...
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_SERVICE_GROUP),
                serviceFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_SERVICE_PRIVATE),
                serviceFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_SERVICE_FREE),
                serviceFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_SERVICE_SHOP),
                serviceFuntion));

            FunHeaderItem studentsFuntion = new FunHeaderItem("会员管理");
            mDatas.add(
                new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_STUDENT),
                    studentsFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_STUDENT_CARDS),
                studentsFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_STUDENT_BODY_TEST),
                studentsFuntion));
            mDatas.add(
            ...
            mDatas.add(new GymFuntionItem(
                ...
                internalFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_MANAGE_COACH),
                internalFuntion));
            mDatas.add(
                new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_NONE),
                    internalFuntion));
            ...
            mDatas.add(new GymFuntionItem(
                ...
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_SCORE),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_ACTIVITY),
                runFuntion));
            //                mDatas.add(new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(GymFunctionFactory.MODULE_OPERATE_AD), runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERTAT_KOUBEI),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_REGIST),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_ANOUNCE),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_COMPETITION),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_COUPON),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_RED_EVELOP_TPL),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_PRIVATE_SHARE),
                runFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_OPERATE_GROUP_SHARE),
                runFuntion));
            mDatas.add(new GymFuntionItem(
            ...
            mDatas.add(new GymFuntionItem(
                ...
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_COURSE),
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_SALE),
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_MARK),
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_CARD),
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_SIGN_IN),
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_ORDER),
                financialFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_FINANCE_VISUAL_REPORT),
                financialFuntion));
            ...
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_GYM_TIME), gymFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_GYM_SITE), gymFuntion));
            mDatas.add(
                new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_MSG),
                    gymFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_WARDROBE), gymFuntion));
            mDatas.add(
                new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_HOME),
                    gymFuntion));
            ...
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_DATA_WHITEPAPER),
                dataFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_DATA_INCOME), dataFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_DATA_MEMBER), dataFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_DATA_GROUP), dataFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_DATA_PRIVATE),
                dataFuntion));
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_DATA_BIG), dataFuntion));
            mDatas.add(
                new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_NONE),
                    dataFuntion));
            mDatas.add(
            ...
            mDatas.add(new GymFuntionItem(
                GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_SMARTGYM_SMART),
                smartFuntion));
            mDatas.add(
                new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(QRActivity.MODULE_NONE),
                    smartFuntion));
  ...
  @Override public boolean onItemClick(int position) {
    if (mAdapter.getItem(position) instanceof GymFuntionItem) {
      if (mEditableMode) {
        ...
        String moduleName =
            ((GymFuntionItem) mAdapter.getItem(position)).getGymFuntion().getModuleName();
        if (!gymWrapper.isPro() && GymFunctionFactory.getModuleStatus(moduleName) > 0) {
  ...
  @Override public void onModule(List<String> modules) {
    ...
    if (modules != null) {
      for (int i = 0; i < modules.size(); i++) {
        ...
        mFunsDatas.add(
            new GymFuntionItem(GymFunctionFactory.instanceGymFuntion(modules.get(i)), mMyFuntions));
      }
    }
