...
public class NotificationItem extends AbstractFlexibleItem<NotificationItem.NotificationVH> {
  ...
  @Override public void bindViewHolder(FlexibleAdapter adapter, NotificationVH holder, int position,
    ...
    Glide.with(adapter.getRecyclerView().getContext())
        .load(PhotoUtils.getSmall(entity.getPhoto()))
  ...
  @Override public boolean equals(Object o) {
    return o instanceof NotificationItem
        && ((NotificationItem) o).getMsg() != null
        && ((NotificationItem) o).getMsg().getId().equals(getMsg().getId());
  }
