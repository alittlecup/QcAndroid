...
public class FilterCommonFragment extends BaseFragment
    implements StudentListView, DrawerLayout.DrawerListener {

  public static final int SORT_TYPE_ALPHA = 684;//字母排序
  public static final int SORT_TYPE_REGISTER = 685;//最新注册时间排序

  public QcToggleButton tvSortAlpha;
  public QcToggleButton tvSortRegister;
  public QcToggleButton tvSortFilter;
  public DrawerLayout drawer;
  public AlphabetView alphabetView;
  public TextView alphaTextDialog;
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    tvSortAlpha = view.findViewById(R.id.tv_sort_alpha);
    tvSortRegister = view.findViewById(R.id.tv_sort_register);
    tvSortFilter = view.findViewById(R.id.tv_sort_filter);
    drawer = view.findViewById(R.id.drawer);
    alphabetView = view.findViewById(R.id.alphabetview);
    alphaTextDialog = view.findViewById(R.id.alphaTextDialog);
  ...
  private void initView() {
    ...
    alphabetView.setOnTouchListener((v, event) -> {
      ...
      if (searchviewEt != null && TextUtils.isEmpty(searchviewEt.getText())) {
  ...
  public void onClickFilterUIChange() {
    ...
    if (isFilter && ((filter.status != null && !filter.status.isEmpty()) || filter.sale != null || (
        !TextUtils.isEmpty(filter.registerTimeStart)
            && !TextUtils.isEmpty(filter.registerTimeEnd)) || (filter.referrerBean != null) || (
        filter.sourceBean
            != null))) {
      ...
      VectorDrawableCompat drawable =
          VectorDrawableCompat.create(getResources(), R.drawable.vector_list_filter_normal, null);
      DrawableCompat.setTint(drawable,
          ContextCompat.getColor(getActivity(), R.color.qc_theme_green));
      drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
      ...
      VectorDrawableCompat drawable =
          VectorDrawableCompat.create(getResources(), R.drawable.vector_list_filter_normal, null);
      DrawableCompat.setTint(drawable,
          ContextCompat.getColor(getActivity(), R.color.qc_text_black));
      drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
