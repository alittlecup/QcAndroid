 ...
 */
public class AllotSaleShowSelectDialogFragment extends BottomSheetDialogFragment
    implements HandleClickClearAll {
  ...
  @Nullable @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    binding = DataBindingUtil.inflate(inflater, R.layout.dialog_fragment_allotsale_show_selected,
        container, false);
  ...
  @Override public void handleBindClick(View view) {
    DialogUtils.showConfirm(view.getContext(), "", getString(R.string.qc_allotsale_clear_alert),
        (dialog, action) -> {
          dialog.dismiss();
          if (action == DialogAction.POSITIVE) clearAllSelected();
        });
  }
