...
public class MainActivity extends BaseActivity implements FragCallBack {
    ...
    @Inject
    GymBaseInfoAction gymBaseInfoAction;
    ...
    private int[] mIconSelect = {
            R.drawable.vd_tabbar_manage_active, R.drawable.vd_tabbar_discover_active, R.drawable.vd_tabbar_none,
            R.drawable.vd_tabbar_message_active, R.drawable.vd_tabbar_mine_active
    };
    private int[] mIconNormal = {
            R.drawable.vd_tabbar_manage_normal, R.drawable.vd_tabbar_discover_normal, R.drawable.vd_tabbar_none,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBackMainOb.subscribe(new Action1<EventInitApp>() {
            @Override
            public void call(EventInitApp eventInitApp) {
                try {
        ...
        brandChangeOb.observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<EventBrandChange>() {
                    @Override
                    public void call(EventBrandChange eventBrandChange) {
...
//                        updateAdText(s);
    ...
    public Fragment generateFragment(int pos) {
        switch (pos) {
            ...
            case 2:
                return QcVipFragment.newInstance(Configs.URL_ALI_Eleven.replace("http", "https"), true);
            case 3:
                                ...
                                try {
                                    ...
                                    if (BuildConfig.DEBUG) {
                                        ...
                                        if (updateVersion.version > AppUtils.getAppVerCode(App.context)) {
                                            ...
                                            if (show)
                                                ToastUtils.showS(getString(R.string.is_latest_version));
                                        }
                                    }
                                } catch (Exception e) {
    ...
    @Override
    public void setToolbar(String title, boolean showRight, View.OnClickListener titleClick,
