...
public class QCDbManagerImpl implements QcDbManager{
  ...
  public  Observable<List<QcStudentBean>> getAllStudent() {
    return briteDatabase.createQuery(QcStudentBean.TABLE_NAME,
        QcStudentBean.FACTORY.getAllStudent().statement)
  ...
  public  Observable<QcStudentBean> getStudentById(String id) {
    ...
    return briteDatabase.createQuery(QcStudentBean.TABLE_NAME, statement.statement, statement.args)
  ...
  public  Observable<QcStudentBean> getStudentByPhone(String phone) {
  ...
  public  Observable<List<QcStudentBean>> getStudentByKeyWord(final String keyword,
    ...
    return briteDatabase.createQuery(QcStudentBean.TABLE_NAME, sqlStr, getLikeString(keyword),
        getLikeString(keyword), brandid).mapToList(new Func1<Cursor, QcStudentBean>() {
      @Override public QcStudentBean call(Cursor cursor) {
        return QcStudentBean.MAPPER.map(cursor);
      }
    });
  ...
  public  Observable<List<QcStudentBean>> getStudentByKeyWordShop(String brandid,
      String shopid, final String keyword) {
    String sqlStr = "SELECT *\n"
  ...
  public  Observable<List<QcStudentBean>> getStudentByGym(String shopid) {
    return briteDatabase.createQuery(QcStudentBean.TABLE_NAME,
  ...
  public  void delStudentByGym(final String gymid, final String gymmodel, final String id) {
    getStudentById(id).observeOn(Schedulers.io())
        ...
        .subscribe(new Subscriber<QcStudentBean>() {
          ...
          @Override public void onNext(QcStudentBean bean) {
            String shopid = getGymNow(gymid, gymmodel).shop_id();
            String shopname = getGymNow(gymid,gymmodel).getName();
            ...
            briteDatabase.update(QcStudentBean.TABLE_NAME,
                QcStudentBean.FACTORY.marshal(bean).asContentValues(), QcStudentBean.ID,
                bean.getId());
          }
        });
  }
  ...
  public  void saveStudent(final QcStudentBean qcStudent) {
    briteDatabase.createQuery(QcStudentBean.TABLE_NAME,
        QcStudentBean.FACTORY.getStudentById(qcStudent.getId()).statement)
        .mapToOne(new Func1<Cursor, QcStudentBean>() {
          @Override public QcStudentBean call(Cursor cursor) {
            return QcStudentBean.MAPPER.map(cursor);
          }
        ...
        .subscribe(new Subscriber<QcStudentBean>() {
          ...
          @Override public void onNext(QcStudentBean qcStudentBean) {
            ...
            if (qcStudentBean != null) {
              ...
              briteDatabase.update(QcStudentBean.TABLE_NAME,
                  QcStudentBean.FACTORY.marshal(qcStudent).asContentValues(),
              ...
              briteDatabase.insert(QcStudentBean.TABLE_NAME,
                  QcStudentBean.FACTORY.marshal(qcStudent).asContentValues());
            }
          }
        });
  ...
  public  void saveStudent(List<QcStudentBean> studentBeens, String brandid) {
    ...
    try {
      ...
      for (QcStudentBean studentBean : studentBeens) {
        briteDatabase.insert(QcStudentBean.TABLE_NAME,
            QcStudentBean.FACTORY.marshal(studentBean).asContentValues());
      }
  ...
  public  Observable<List<CoachService>> getAllCoachService() {
    return briteDatabase.createQuery(CoachService.TABLE_NAME,
        CoachService.FACTORY.getAllCoachService().statement)
  ...
  public  Observable<List<CoachService>> getAllCoachServiceByBrand(String brandId) {
    return briteDatabase.createQuery(CoachService.TABLE_NAME,
  ...
  public  void writeGyms(final List<CoachService> services) {
    ...
    try {
      ...
      for (CoachService service : services) {
        ...
        briteDatabase.insert(CoachService.TABLE_NAME,
            CoachService.FACTORY.marshal(service).asContentValues());
      }
      transaction.markSuccessful();
    } finally {
      transaction.end();
  ...
  public  Observable<List<CoachService>> getGymByModel(String id, String model) {
    return briteDatabase.createQuery(CoachService.TABLE_NAME,
  ...
  public  Observable<List<CoachService>> getGymByGymId(String gymid) {
    return briteDatabase.createQuery(CoachService.TABLE_NAME,
  ...
  public  Observable<List<CoachService>> getGymByShopIds(String brandid,
  ...
  public  void writePermiss(final List<Permission> permissions) {
    ...
    try {
      for (Permission permission : permissions) {
        briteDatabase.insert(Permission.TABLE_NAME,
            Permission.FACTORY.marshal(permission).asContentValues());
      }
      transaction.markSuccessful();
    } catch (Exception e) {
