...
public class ShopConfigs {
     ...
     * },
     */
    public static final String TEAM_SMS_TEACHER_AFTER_USER_ORDER_SAVE = "team_sms_teacher_after_user_order_save";
    /**
     *
     */
    public static final String TEAM_SMS_USER_AFTER_USER_ORDER_SAVE = "team_sms_user_after_user_order_save";
    /**
     *
     */
    ...
    public static final String TEAM_SMS_USER_AFTER_TEACHER_ORDER_CANCEL = "team_sms_user_after_teacher_order_cancel";
    ...
    public static final String TEAM_COURSE_REMIND_TEACHER_MINUTES = "team_course_remind_teacher_minutes";
    ...
    public static final String PRIVATE_SMS_TEACHER_AFTER_USER_ORDER_SAVE = "private_sms_teacher_after_user_order_save";
    public static final String PRIVATE_SMS_USER_AFTER_USER_ORDER_SAVE = "private_sms_user_after_user_order_save";
    public static final String PRIVATE_SMS_TEACHER_AFTER_USER_ORDER_CANCEL = "private_sms_teacher_after_user_order_cancel";
    public static final String PRIVATE_SMS_USER_AFTER_USER_ORDER_CANCEL = "private_sms_user_after_user_order_cancel";
    public static final String PRIVATE_SMS_USER_AFTER_TEACHER_ORDER_SAVE = "private_sms_user_after_teacher_order_save";
    public static final String PRIVATE_SMS_TEACHER_AFTER_TEACHER_ORDER_SAVE = "private_sms_teacher_after_teacher_order_save";
    public static final String PRIVATE_SMS_TEACHER_AFTER_TEACHER_ORDER_CANCEL = "private_sms_teacher_after_teacher_order_cancel";
