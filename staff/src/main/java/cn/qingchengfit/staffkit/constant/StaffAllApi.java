...
public interface StaffAllApi {
  ...
  @PUT("api/brands/{id}/") Observable<QcResponse> qcEditBrand(@Path("id") String brand_id, @Body
      BrandBody body);
  ...
  //修改信息
  @PUT("/api/staffs/{id}/") rx.Observable<QcResponse> qcModifyStaffs(@Path("id") String id, @Body
      Staff staffBean);
  ...
  //百度pushid绑定
  @POST("/api/staffs/{id}/push/update/") rx.Observable<QcResponse> qcPostPushId(@Path("id") String id, @Body
      PushBody body);
  ...
  @POST("/api/brands/") rx.Observable<QcDataResponse<CreatBrand>> qcCreatBrand(@Body
      CreatBrandBody body);
  ...
  @PUT("/api/staffs/{id}/measures/{measure_id}/") rx.Observable<QcResponse> qcUpdateBodyTest(@Path("id") String staff_id,
      @Path("measure_id") String id, @QueryMap HashMap<String, Object> params, @Body
      BodyTestBody addBodyTestBean);
  ...
  //新建卡模板
  rx.Observable<QcResponse> qcCreateCardtpl(@Path("staff_id") String staffid, @Body
      CardtplBody body,
      @QueryMap HashMap<String, Object> params);
   ...
   * 创建课程
   */
  @POST("/api/v2/staffs/{id}/courses/") rx.Observable<QcResponse> qcCreateCourse(@Path("id") String staffid, @Body
  ...
  @PUT("/api/v2/staffs/{staff_id}/lockers/{locker_id}/") rx.Observable<QcDataResponse<LockerWrapper>> qcEditLocker(@Path("staff_id") String staff_id,
      @Path("locker_id") String lockerid, @QueryMap HashMap<String, Object> params, @Body
      EditWardrobeBody body);
  ...
  //新建分组
  @POST("api/staffs/competitions/teams/") rx.Observable<QcResponse> qcPostCreateGroup(@Body
