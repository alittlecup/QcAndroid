...
public class ConstantNotification {
    ...
    public static final int[] GYM_NOTIFICATION = {
        TYPE_FITNESS_SELLER_CHANGED, TYPE_FITNESS_WITHOUT_SELLER, TYPE_FITNESS_REMIND_CARD_BALANCE, TYPE_FITNESS_AFTER_CARD_ORDER_DONE,
    };
    /*
       系统通知
     */
    public static final String SYSTEM_NOTIFICATION_STR = "system";
    public static final int[] SYSTEM_NOTIFICATION = { TYPE_CLOUD_MESSAGE_STAFF };
    /*
     *学习培训
     */
    ...
    public static final String[] NOTISORDERS = {
        GYM_NOTIFICATION_STR, SYSTEM_NOTIFICATION_STR, STUDY_TRAIN_NOTIFICATION_STR, CHECKIN_NOTI_STR, COMPETITION_NOTI_STR,
