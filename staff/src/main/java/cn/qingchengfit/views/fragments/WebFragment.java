...
//import cn.qingchengfit.staffkit.views.WebShowQcCodeDialogBuilder;
...
//                cn.qingchengfit.views.fragments.ShareDialogFragment.newInstance(bean.title, bean.desc, bean.imgUrl, bean.link).show(getFragmentManager(), "");
//            } catch (Exception e) {
//
//            }
//        }
