...
public class Attendance implements Parcelable {
    public static final Parcelable.Creator<Attendance> CREATOR = new Parcelable.Creator<Attendance>() {
        @Override public Attendance createFromParcel(Parcel source) {
            return new Attendance(source);
        }

        @Override public Attendance[] newArray(int size) {
            return new Attendance[size];
        }
    };
    public int checkin;
    @SerializedName("group") public int group_num;
    @SerializedName("private_count") public int private_num;
    public int days;
    @SerializedName("user") public Student student;
