 ...
 */
public class CourseComparator implements Comparator<CourseTypeSample> {
    ...
    public int compare(CourseTypeSample course1, CourseTypeSample course2) {
        String o1 = course1.getName();
        String o2 = course2.getName();
