...
@Trunk(fragments = {
    ...
    AllotChooseCoachPage.class, StudentHomePage.class, StudentFilterView.class,
    FollowUpFilterEndView.class, ViewModelModule.class
}) public class StudentActivity extends SaasContainerActivity implements FragCallBack {

  StudentRouterCenter routerCenter;

  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    StudentActivityViewModel activityViewModel =
  ...
  @Override protected Fragment getRouterFragment(Intent intent) {
    if (routerCenter == null) {
      routerCenter = new StudentRouterCenter().registe(new studentImpl());
    }
    if (intent.getData().getPath().equalsIgnoreCase("/attendance/page") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/attendance/absent") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/attendance/rank") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/attendance/nosign") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/followup/student") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/followup/status") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/allot/student") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/allotstaff/detail") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/allot/choosesaler") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/allot/choosecoach") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/allotstaff/multi") || intent.getData()
        .getPath()
        .equalsIgnoreCase("/home/student")) {
