...
public interface StudentRepository {
  ...
  //
  LiveData<Resource<AttendanceCharDataBean>> qcGetAttendanceChart(String id,
      HashMap<String, Object> params);

  //
  LiveData<Resource<AbsentceListWrap>> qcGetUsersAbsences(String id,
      HashMap<String, Object> params);

  //
  LiveData<Resource<AttendanceListWrap>> qcGetUsersAttendances(String id,
      HashMap<String, Object> params);

  //
  //
  LiveData<Resource<List<StudentWIthCount>>> qcGetNotSignStudent(String staffId,
      HashMap<String, Object> params);

  //
  //
  LiveData<Resource<StudentTransferBean>> qcGetTrackStudentsConver(String staff_id,
      HashMap<String, Object> params);
  ...
  //
  void qcRemoveStaff(MutableLiveData<Boolean> result,
  ...
  void qcGetSalers(MutableLiveData<List<Staff>> result,
  ...
  LiveData<Resource<StatDate>> qcGetFollowStat(HashMap<String, Object> params);

  LiveData<Resource<StudentListWrappeForFollow>> qcGetTrackStudentFollow(
  ...
  LiveData<Resource<QcStudentBirthdayWrapper>> qcGetStudentBirthday(Map<String, Object> params);
  ...
  void qcEditTrackStatus(String status_id, HashMap<String, Object> params,
      MutableLiveData<Resource<Object>> rst);
