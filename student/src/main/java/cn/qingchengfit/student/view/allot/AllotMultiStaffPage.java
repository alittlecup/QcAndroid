  ...
  private void routeTo(String title) {
    ...
    switch (getActivityViewModel().getAllotType()) {
      case 0:
        ...
        routeTo(toSaler,
            new cn.qingchengfit.student.view.allot.AllotChooseCoachPageParams().title(title)
                .studentIds(ids)
                .textContent(
      ...
      case 1:
        ...
        routeTo(toCoach,
            new cn.qingchengfit.student.view.allot.AllotChooseSalerPageParams().title(title)
                .studentIds(ids)
