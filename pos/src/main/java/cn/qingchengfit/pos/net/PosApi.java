...
public interface PosApi {
  ...
  //获取筛选列表
  @GET("/api/staffs/{id}/filter/cardtpls/?show_all=1") rx.Observable<QcDataResponse<CardTplListWrap>> qcGetCardFilterCondition(
   ...
   * @param card_id 卡id
   */
  @GET("/api/staffs/{id}/cards/{card_id}/") rx.Observable<QcDataResponse<CardWrap>> qcGetCardDetail(@Path("id") String staff,
      @Path("card_id") String card_id, @QueryMap HashMap<String, Object> params);

  /**
   * 会员卡绑定会员
   */
  @GET("/api/staffs/{id}/cards/bind/users/") rx.Observable<QcDataResponse<StudentListWrapper>> qcGetBindStudent(@Path("id") String staff,
      @QueryMap HashMap<String, Object> params);

  /**
   * 卡规格操作
   */
  @DELETE("/api/staffs/{staff_id}/options/{option_id}/") rx.Observable<QcDataResponse> qcDelCardtplOption(@Path("staff_id") String staffid,
      @Path("option_id") String option_id, @QueryMap HashMap<String, Object> params);

  @PUT("/api/staffs/{staff_id}/options/{option_id}/") rx.Observable<QcDataResponse> qcUpdateCardtplOption(@Path("staff_id") String staffid,
      @Path("option_id") String option_id,@QueryMap HashMap<String, Object> params,
      @Body OptionBody body);

  @POST("/api/staffs/{staff_id}/cardtpls/{card_tpl_id}/options/") rx.Observable<QcDataResponse> qcCreateCardtplOption(
      @Path("staff_id") String staffid, @Path("card_tpl_id") String card_tpl_id, @QueryMap HashMap<String, Object> params, @Body OptionBody body);

  /**
   * 卡类型
   */
  @POST("/api/staffs/{staff_id}/cardtpls/")
  rx.Observable<QcDataResponse> qcCreateCardtpl(@Path("staff_id") String staffid, @Body CardtplBody body,
      @QueryMap HashMap<String, Object> params);

  @PUT("/api/staffs/{staff_id}/cardtpls/{card_tpl_id}/") rx.Observable<QcDataResponse> qcUpdateCardtpl(@Path("staff_id") String staffid,
      @Path("card_tpl_id") String card_tpl_id, @Body CardtplBody body, @QueryMap HashMap<String, Object> params);
  /**
   * 停用会员卡种类
   */
  @DELETE("/api/staffs/{staff_id}/cardtpls/{card_tpl_id}/") rx.Observable<QcDataResponse> qcDelCardtpl(@Path("staff_id") String staffid,
